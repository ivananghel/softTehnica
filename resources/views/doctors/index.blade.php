            ...
            <div class="row">
                <div class="col-xs-7 col-sm-5 col-lg-8">
                    <h1 class="page-title txt-color-blueDark">
                        ...
                        {{ trans('lang.doctor_management') }}
                    </h1>
                </div>
                <div class="col-xs-5 col-sm-7 col-lg-4 padding-10">
                    <a href="#" ajax_target="doctors/create" class="btn btn-success pull-right remote_modal">
                        <i class="fa fa-plus"></i> {{trans('lang.add_doctor')}}
                    </a>
                </div>
            </div>
            <!-- widget grid -->
        ...
        $(document).ready(function () {
            ...
            otable = $('#datatable_fixed_column').DataTable({
                ...
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
                    {data: 'type_procedure', name: 'type_procedure'},
            ...
            $(document).on('submit', '.remove-resource', function (e){
                ...
                $.SmartMessageBox({
                    ...
                    content : '{{ trans('lang.confirm_remove').' '.trans('lang.doctor') }}?',
